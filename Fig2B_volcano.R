##setwd("~/Desktop/depression/GSE109315/res_vs_ctrl")

df1 <- read.csv("vHPC_log2CPM_CvsR_full_results_mapped.csv", row.names = 1)
...
ggsave("vHPC_res_v.jpeg", plot = p, width = 5.4, height = 4.2, dpi = 300)
